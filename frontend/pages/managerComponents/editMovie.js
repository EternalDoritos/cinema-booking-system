  ...
  return (
    <>
      ...
      <div className="text-center flex flex-col m-4">
        <div>
          <button className="m-4 text-xl font-bold rounded-full bg-cyan-900 p-5 m-4">
            Create New Movie
          </button>
        </div>
        <div>
          ...
          {update && (
            <div>
              ...
              <button className="m-2 text-l font-bold rounded-full bg-green-500 p-2 px-6 m-2">
                Update
              </button>
            </div>
          )}
        ...
        <div>
          ...
          {deleteEle && (
            <div>
              ...
              <button className="m-2 text-l font-bold rounded-full bg-red-500 p-2 px-6 m-2">
                Delete
              </button>
            </div>
          )}
